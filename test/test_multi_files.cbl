      ...
      *> 程序ID: TESTPGM
       ...
       FILE-CONTROL.
           SELECT IN1
              ASSIGN TO SYS010
              FILE STATUS IS W-FS-IN1
              ACCESS MODE IS SEQUENTIAL.
           SELECT OUT1
              ASSIGN TO SYS020
              FILE STATUS IS W-FS-OUT1
              ACCESS MODE IS SEQUENTIAL.
       ...
       FD  IN1
           ...
           RECORDING MODE F.
               01  FI01-IN1-REC.
               05  FI01-FIELD1 PIC X(10).
       FD  OUT1
           LABEL RECORD STANDARD
           BLOCK CONTAINS 0 CHARACTERS
           RECORDING MODE F.
               01  FO01-OUT1-REC.
               05  FO01-FIELD1 PIC X(10).
      ...
      *> 文件状态变量
       01  W-IN1-AREA.
           03  W-FS-IN1 PIC X(02).
       01  W-OUT1-AREA.
           03  W-FS-OUT1 PIC X(02).
      *> 常量区
       01  CONSTANT-AREA.
      ...
      *> 自定义变量
       01  USER-VARIABLES.
       05  MY_VAR                         PIC X(10)  VALUE 'HELLO'.
      ...
      *> 初始化
           ...
           INITIALIZE W-IN1-AREA
           INITIALIZE W-OUT1-AREA
